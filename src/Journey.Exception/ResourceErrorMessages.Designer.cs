...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        public static string ENDDATE_MUST_BE_LATER_THAN_STARTDATE {
            get {
                return ResourceManager.GetString("ENDDATE_MUST_BE_LATER_THAN_STARTDATE", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Consulta uma cadeia de caracteres localizada semelhante a Start Date cannot be later than today..
        /// </summary>
